...
Everything else in this repository, including the remaining sections of the specification, the fixtures, the conformance template, the tooling and this file, is licensed under the Creative Commons Attribution 4.0 International licence. The full text is in [`LICENSES/CC-BY-4.0.md`](LICENSES/CC-BY-4.0.md).
